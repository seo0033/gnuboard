...
<!-- 게시물 읽기 시작 { -->
<section id="bo_v" style="width:<?php echo $width; ?>" class="fz_wrap">
    <!-- 게시물 상단 버튼 시작 { -->
    <div id="bo_v_top">
        <?php
        ob_start();
        ...
        <ul class="bo_v_com">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="list_btn btn_edit"><i class="fa fa-check"></i> 수정</a></li><?php } ?>
            ...
            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="list_btn btn_reply"><i class="fa fa-rotate-right"></i> 답변</a></li><?php } ?>
	...
	<section id="bo_v_info">
		...
		<div class="fr">
			...
			<span class="bo_v_hit"><i class="fa fa-eye"></i> <span class="hidden-xs">조회</span> <strong><?php echo number_format($view['wr_hit']) ?></strong></span> <span class="bar">|</span>
			<span class="bo_v_comment"><i class="fa fa-comments"></i> <span class="hidden-xs">댓글</span> <strong><?php echo number_format($view['wr_comment']) ?></strong></span>
		</div>
	</section>
...
<div class="main_portfolio pd15">
<h2>" 20년 전통의 믿을 수 있는 부산사무가구 전문점 "</h2>
<hr class="dotline">

					<p>
					하이퍼스트 OA퍼니처는 <br>
					효율적인 사무실 환경과 구성원의 창의력과 팀웍을 북돋우는 사무공간을 창출하는 <br>
					부산사무가구 전문점입니다.<br>
					실용성과 합리적인 단가를 가진 사무용 가구만을 취급하고 있으며 <br>
					오랜 사무환경 인테리어 경험과 사무가구 설치 및 시공 경험을 바탕으로 <br>
					가장 합리적인 견적으로 가장 효율적인 사무환경을 만드는 <br>
					인테리어를 도와드릴것입니다.<br>
					믿고 맡겨주시면 보답하는 마음으로 잘 하겠습니다. <br><br>

					#부산사무가구 #부산사무실가구 #부산사무용가구
					</p>

<hr class="dotline">
<h2>" 업소가구 전문 견적 및 시공 전문 가구점 "</h2>
<hr class="dotline">
					<p>
					하이퍼스트 OA퍼니처는 <br> 
					부산에서 20여년 동안 업소 인테리어와 환경에 맞는 가구 일체를 납품해 온 업소가구 전문 견적 및 시공 전문 가구점입니다. <br>
					그간의 경험을 바탕으로 합리적인 견적의 대량납품이 가능하며  <br>
					내구성이 뛰어난 식당 가구를 중심으로 여러 업소에 다양한 제품을 납품해 오고 있습니다. <br>
					고객님의 매출증대에 꼭 필요한 힘이 되어 드리겠습니다.<br><br>

					#부산업소가구 #부산식당가구 
					</p>

<hr class="dotline">
<h2>문의전화  : <a href="tel:<?php echo $mg_tel; ?>"><?php echo $mg_tel; ?></a></h2>
<hr class="dotline">
		...
		<div class="article_score">
			...
			<div class="graph">
				...
				<span class="score_bar_wrap"><span id="score_bar" class="score_bar" style="width:<?=$size?>%;"><span class="line_border"></span></span></span>
