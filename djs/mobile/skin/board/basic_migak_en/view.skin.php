    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		<span class="sound_only">name</span> <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong><br>
        		...
        		<span class="sound_only">hit</span><strong><i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?>hit</strong>
    ...
    <section id="bo_v_link">
        ...
        for ($i=1; $i<=count($view['link']); $i++) {
            ...
            <li>
                ...
                <br>
                <span class="bo_v_link_cnt"><?php echo $view['link_hit'][$i] ?> </span>
            </li>
            <?php
            }
        }
