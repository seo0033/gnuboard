...
<div class="section_hori">
    ...
    <?php //echo print_r2($list[0]);?>
	<div class="main">
		<div class="img_main">
			<a href="<?php echo $list[0]['href'];?>"><span class="roll travel1"></span><?php echo $img;?></a>
    ...
    <div class="sub">
		...
		<?php
            ...
            <li <?php if($i==1){?>class="fst"<?php }?>>
				<div class="img_sub"><a href="<?php echo $list[$i]['href'];?>"><span class="roll travel2"></span><?php echo $img;?></a></div>
                <div class="inner_sub">
